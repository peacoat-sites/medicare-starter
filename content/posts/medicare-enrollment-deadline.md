...
faqs:
 ...
 - q: "Can I sign up for Medicare before I retire if I'm still working at 65?"
   a: "Yes, and sometimes it makes sense. If your employer has fewer than 20 employees, Medicare is typically expected to be your primary insurance at 65, and you should enroll in both Part A and Part B during your IEP. If your employer has 20 or more employees and you're covered under an active employee plan, you have more flexibility to delay Part B without penalty."
 - q: "Does my spouse's employer coverage count to protect me from Medicare late penalties?"
   a: "Yes, as long as it's coverage through your spouse's current active employment. Retiree coverage from a former employer does not qualify, even if your spouse recently retired. Make sure to confirm the plan qualifies as creditable coverage each year."
...
When that employer coverage ends, you get an eight-month [Special Enrollment Period](/medicare-special-enrollment-period/) (SEP) to sign up for Part B. Eight months sounds like plenty of time, and it is, but here's the trap: if you want a Part D drug plan, you only have 63 days from when your employer coverage ends to enroll before penalties start. Those two timelines are different, and every year people get the Part B piece right and then forget about Part D until it's too late.

I'd also caution you not to confuse "creditable coverage" with just having insurance. The IRS and Medicare definitions are specific. If your employer plan is considered creditable drug coverage (your plan administrator is required to tell you this in writing each year), you're protected. If it isn't, penalties can apply even if you technically had insurance. When in doubt, get that notice in writing and keep it somewhere you can actually find it.

A reader emailed me a few months ago who had been on her husband's retiree health plan for three years, thinking that gave her protected status to delay Medicare. It didn't. She owed a late enrollment penalty of 10% added to her Part B premium for every 12-month period she was late. On a base premium of $185 per month (the 2025 standard Part B premium), even a two-year delay means you're paying roughly $222 a month instead. For the rest of your life. That's not a hypothetical. It's exactly how the penalty works.

## The Annual Enrollment Period Is Not Your Backup for Late Signups

I want to clear up a misconception I encounter constantly.

The Annual Enrollment Period, or AEP, runs from October 15 to December 7 every year. This is when you can switch Medicare Advantage plans, move from Medicare Advantage back to Original Medicare, or change [Part D drug plan](/how-to-sign-up-for-medicare/)s. Coverage for any changes made during AEP starts January 1.
...
Beyond leaving employer coverage, there are quite a few circumstances that trigger an SEP. Losing Medicaid. Moving to a new service area. Your plan leaving Medicare. A qualifying change in your household circumstances, including things like moving into or out of a nursing facility or care facility.

The rules around each SEP are specific to the situation, and the window length varies. Some are two months, some are three, some are tied to exactly when you notify Medicare of the qualifying event. This is not a place to guess or go by what your neighbor told you. [AARP's Medicare resource center](https://www.aarp.org/health/medicare-insurance/) has situation-by-situation guidance, and it's written in language that doesn't require a law degree.

One that surprises people: if you're receiving Social Security benefits when you turn 65, you're generally enrolled in Part A and Part B automatically. You'll get a Medicare card in the mail about three months before your 65th birthday. A lot of people don't realize this and don't take any action, then wonder why they were enrolled when they wanted to delay. If you want to delay Part B because you have employer coverage, you have to actively decline it, not just ignore the card.
...
- [Medicare Plan Finder on Medicare.gov](https://www.medicare.gov/plan-compare/)
- [Life Alert Style Medical Alert Button for Seniors](https://www.amazon.com/dp/B076BGJFM4?tag=contentportfo-20)
