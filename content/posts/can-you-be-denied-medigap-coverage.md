---
title: "Medigap Coverage Denial: When Insurers Can Say No"
date: 2026-07-13T16:42:02.439973+00:00
draft: false
description: "Learn when Medigap insurers can deny coverage, what protections exist, and your rights if rejected for supplemental insurance."
image: "/img/heroes/8439662.jpg"
categories: ["Medigap Plans"]
tags: ["denied", "medigap", "coverage"]
author: "Susan Park"
...
slug: "can-you-be-denied-medigap-coverage"
affiliate_disclosure: true
faqs:
  - q: "Can you be denied Medigap if you have a pre-existing condition?"
    a: "Yes, outside of protected enrollment windows, Medigap insurers in most states can deny you coverage or charge more based on pre-existing conditions. Your safest window is during your six-month Medigap Open Enrollment Period that begins when you first enroll in Part B at age 65. Some states offer stronger year-round protections."
  - q: "What if you missed your Medigap open enrollment period?"
    a: "You're not necessarily out of options, but you'll likely face medical underwriting. Check whether your state has birthday rule protections or year-round guaranteed issue. Also confirm whether a qualifying life event (like losing other coverage) gives you a federal guaranteed issue right, which bypasses underwriting for 63 days."
  - q: "Does having Medicare Advantage instead of Medigap affect your rights if you want to switch later?"
    a: "It can complicate things significantly. If you enroll in Medicare Advantage at 65 instead of getting Medigap, and later want to switch back to Original Medicare with a Medigap policy, you'll typically face underwriting unless a specific guaranteed issue trigger applies. This is one of the least-discussed risks of choosing Advantage plans at the beginning of Medicare eligibility."
  - q: "Are all Medigap plans subject to the same underwriting rules?"
    a: "Underwriting rules apply to all standardized Medigap plans (A through N), but the specific health questions and acceptance thresholds vary by insurer. One company may automatically decline applicants with a recent cancer diagnosis; another may approve with a waiting period. Shopping multiple carriers matters."
  - q: "Can ESRD (end-stage renal disease) cause a Medigap denial?"
    a: "Yes. Federally, people with ESRD are not guaranteed the right to purchase Medigap during their initial Medicare enrollment period (they're often directed to Medicare Advantage or Medicare's own cost-sharing). This changed somewhat with the 21st Century Cures Act for some ESRD patients newly eligible for Medicare Advantage, but Medigap access for ESRD patients remains one of the more complicated areas of Medicare law. Consult a SHIP counselor at shiphelp.org if this applies to you."
---
...
This is where I want to be specific, because the generic answer ("it depends on the insurer") isn't helpful.
...
| State | Additional Protections Beyond Federal Law |
|---|---|
| New York | Year-round guaranteed issue, all standardized plans |
| Connecticut | Year-round guaranteed issue, all standardized plans |
| Massachusetts | Own Medigap framework; continuous enrollment protections |
| California | Annual birthday rule (60-day window each year) |
| Oregon | Birthday rule (60 days after birthday) |
| Idaho | Birthday rule (63 days after birthday) |
| Illinois | Birthday rule; limited guaranteed issue for certain plan switches |
| Missouri | Birthday rule (30-day window; Plan A and Plan B only) |

If you live in one of these states, your options after your OEP are meaningfully better than in, say, Texas or Florida. I don't have complete data on every state-level variation, so I'd strongly encourage you to check with your State Health Insurance Assistance Program (SHIP) at [shiphelp.org](https://www.shiphelp.org), where free, unbiased counselors can tell you exactly what applies where you live.
...
- [Medicare.gov](https://www.medicare.gov): Official federal Medicare resource for plan comparison, enrollment periods, and Medigap standardized plan details
- [SHIP National Technical Assistance Center (shiphelp.org)](https://www.shiphelp.org): Free state-by-state Medicare counseling; authoritative on local Medigap rules
- [Centers for Medicare & Medicaid Services (CMS), "Choosing a Medigap Policy" guide](https://www.medicare.gov/publications/02110-choosing-a-medigap-policy.pdf): Federal publication on Medigap rights, underwriting rules, and guaranteed issue protections (updated regularly)
- National Association of Insurance Commissioners (NAIC): Tracks state-level Medigap regulatory variations and consumer protection rules
- Kaiser Family Foundation (KFF): Research on Medicare beneficiary coverage gaps and supplemental insurance enrollment patterns
