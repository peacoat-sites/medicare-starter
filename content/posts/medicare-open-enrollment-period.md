---
title: "When Your Medicare Coverage Changes Every Year"
...
- Join a Medicare Part D prescription drug plan if you don't have one
...
|---|---|
| Monthly premium | Your guaranteed cost regardless of usage |
| Annual deductible | What you pay before coverage kicks in |
| Drug formulary tiers | Determines your out-of-pocket cost per prescription |
| In-network providers | Keeps your care covered at the lower rate |
| Maximum out-of-pocket limit | Your financial safety net for a bad health year |
...
I've been doing this long enough to recognize the patterns. Here are the ones that cost people the most.

**Ignoring the ANOC letter.** If your plan is changing your drug coverage and you don't realize it until February, it's too late to switch. Read that letter.

**Choosing based on premium alone.** A $0 premium plan might have a $500 hospital copay and a very narrow drug formulary. Total cost of ownership is what matters, not the monthly sticker price.

**Assuming your doctors are still in-network.** Provider networks change. Always verify, especially if you've recently started seeing a new specialist.

**Confusing AEP with the Medicare Advantage Open Enrollment Period.** There's a separate window, January 1 through March 31, called the Medicare Advantage Open Enrollment Period (MA OEP). During that time, if you're already enrolled in a Medicare Advantage plan, you can switch to a different Advantage plan or go back to Original Medicare (with the option to add a Part D plan). It's a limited do-over, but it only applies to people already in Medicare Advantage, and you can only make one change.
