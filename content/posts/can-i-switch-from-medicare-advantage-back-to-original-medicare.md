...
image: "/img/heroes/7163956.jpg"
categories: ["Medicare Advantage"]
tags: ["switch", "from", "medicare", "advantage", "back"]
author: "Dorothy Chen"
...
slug: "can-i-switch-from-medicare-advantage-back-to-original-medicare"
affiliate_disclosure: true
faqs:
  - q: "Can I switch from Medicare Advantage back to Original Medicare at any time?"
    a: "No. You can only switch during specific enrollment windows: the Annual Enrollment Period (October 15 to December 7), the Medicare Advantage Open Enrollment Period (January 1 to March 31), or a qualifying Special Enrollment Period. Outside these windows, you generally can't make a change until the next open period arrives."
  - q: "Will I automatically get Medigap coverage when I switch back to Original Medicare?"
    a: "No, and this is one of the most important things to understand. Medigap (Medicare Supplement) is sold by private insurance companies, and in most states they can deny you coverage or charge higher premiums based on your health history. You have to apply separately, and you should do it before you formally switch so you know what you're getting into."
  - q: "What happens to my prescription drug coverage if I leave Medicare Advantage?"
    a: "Most Medicare Advantage plans include drug coverage, so when you leave, you lose it. You'll need to enroll in a standalone Part D plan separately, ideally at the same time you switch, to avoid a gap in coverage and potential late enrollment penalties."
  - q: "Is there any scenario where I can switch back outside of the normal enrollment periods?"
...
**Scenario example:**
Retired teacher, age 68, Colorado. Frustrated with prior authorizations on her rheumatology care. Switches back to Original Medicare during the January Open Enrollment Period. Applies for Plan G Medigap. Has well-controlled rheumatoid arthritis on her record. Gets denied by two carriers, approved by a third at $247/month. Still made the switch, still happy with the decision, but the shopping process took six weeks and nearly derailed her timeline.

The lesson: start shopping for Medigap before you formally disenroll from your Advantage plan. Talk to a broker (ideally one who works with multiple carriers, not just one company) or contact your state's [SHIP (State Health Insurance Assistance Program)](https://www.shiphelp.org/) for free, unbiased help. SHIP counselors are volunteers specifically trained to help Medicare beneficiaries, and they have zero financial incentive to steer you anywhere.
...
- [Medicare.gov Plan Finder](https://www.medicare.gov/plan-compare): Official CMS tool for comparing Medicare Advantage and Part D plans, including cost and coverage details.
- [Centers for Medicare & Medicaid Services (CMS)](https://www.cms.gov/): Official federal source for Medicare enrollment rules, Special Enrollment Period criteria, and coverage guidelines.
- [State Health Insurance Assistance Program (SHIP)](https://www.shiphelp.org/): Federally funded, free counseling program for Medicare beneficiaries in every state.
