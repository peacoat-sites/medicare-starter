---
title: "Medicare Cost Sharing: Deductibles, Copays, and Coinsurance Explained"
date: 2026-07-29T15:56:18.644601+00:00
draft: false
description: "Understand Medicare cost sharing including deductibles, copayments, and coinsurance. Learn what you'll pay for Part A, Part B, and prescription drugs."
image: "/img/heroes/7545281.jpg"
categories: ["Medicare Costs"]
tags: ["medicare", "cost", "sharing", "explained"]
author: "Susan Park"
...
slug: "medicare-cost-sharing-explained"
affiliate_disclosure: true
faqs:
  - q: "What is the biggest cost-sharing mistake Medicare beneficiaries make?"
    a: "Assuming Original Medicare works like capped insurance. Without a Medigap policy or Medicare Advantage plan, there's no limit on what you can owe in a year. A serious illness can result in tens of thousands of dollars in 20% coinsurance under Part B alone."
  - q: "Does Medicare have a deductible?"
    a: "Yes, several. Part A has a per-benefit-period hospital deductible ($1,676 in 2026). Part B has an annual deductible ($257 in 2026). Part D plans can charge a drug deductible up to $590 annually. These are separate and don't combine."
  - q: "What's the difference between a copay and coinsurance?"
    a: "A copay is a fixed dollar amount (say, $30 for a primary care visit). Coinsurance is a percentage of the approved cost (like 20% of a $5,000 procedure). Original Medicare mostly uses coinsurance, which means your exposure scales with the cost of care."
  - q: "Do Medigap plans cover prescription drugs?"
    a: "No. Medigap plans sold today don't include drug coverage. You need a separate Part D plan if you want prescription coverage alongside Medigap. This surprises people who assume Medigap is all-inclusive."
  - q: "Can my cost sharing change from year to year?"
    a: "Yes. Medicare adjusts deductibles, coinsurance amounts, and premium figures annually. Medicare Advantage and Part D plans can also change their cost-sharing structures, formularies, and premiums each year. Reviewing your coverage every fall during Open Enrollment (October 15 through December 7) is worth doing, even if you're happy with your current plan."
---

Most people going into Medicare assume cost sharing works like their old [employer insurance](/medicare-and-employer-insurance/). It doesn't. And the gap between that assumption and reality is where a lot of seniors get hurt financially.
...
Here's what trips people up most often: [Original Medicare](/medicare-advantage-vs-original-medicare/) (Parts A and B) has no out-of-pocket maximum. None. You can rack up unlimited costs in a bad year if you don't have supplemental coverage. I've sat across from people who thought Medicare was basically full coverage, and watching that assumption collapse is genuinely hard. Let me lay out exactly how this works.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Original Medicare has no annual out-of-pocket cap, unlimited exposure without a supplement.</li><li style="margin:5px 0">Part A's hospital deductible in 2026 is $1,676 per benefit period, not per year.</li><li style="margin:5px 0">Part B covers 80% of approved costs after a $257 annual deductible; you owe the other 20%.</li><li style="margin:5px 0">Medicare Advantage plans must cap your out-of-pocket costs (currently $9,350 for in-network in 2026).</li><li style="margin:5px 0">Prescription drug costs under Part D vary sharply by plan and drug tier, comparison shopping is worth the hour.</li></ul></div>


## The Part A Puzzle: Hospital Coverage Isn't What You Think

Part A covers inpatient hospital stays, skilled nursing facility care, hospice, and some [home health](/medicare-home-health-care-cost/). Most people pay no premium for Part A (you earned it through payroll taxes). The cost sharing is where it gets complicated.
...
| Part A Service | Cost Sharing (2026) |
|---|---|
...
| Skilled nursing beyond 100 days | Not covered |
...
Part B covers outpatient care: doctor visits, labs, imaging, durable medical equipment, preventive services. The standard premium in 2026 is $185 per month (higher earners pay more through a surcharge called IRMAA, which stands for Income-Related Monthly Adjustment Amount).
...
The [AARP Medicare resource center](https://www.aarp.org/health/medicare-insurance/) has a solid plan comparison tool that lets you see standardized benefits side by side without the sales pressure.
...
The [Centers for Medicare & Medicaid Services](https://www.cms.gov/) publishes plan data annually, and Medicare.gov's Plan Finder tool lets you compare Advantage options by premium, out-of-pocket maximum, and drug formulary all in one place.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">2026 Medicare Part D cost phases</div><div class="sc-row"><span class="sc-label">Annual deductible max</span><span class="sc-track"><span class="sc-bar" style="width:30%"></span></span><span class="sc-val">$590</span></div><div class="sc-row"><span class="sc-label">Out-of-pocket cap (catastrophic)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$2,000</span></div><div class="sc-row"><span class="sc-label">Avg monthly premium (national)</span><span class="sc-track"><span class="sc-bar" style="width:4%"></span></span><span class="sc-val">$46</span></div><div class="sc-src">Source: CMS 2026 Part D parameters</div></div>


## Sources

- [Centers for Medicare & Medicaid Services (CMS)](https://www.cms.gov/): Official 2026 Medicare cost-sharing figures including Part A, B, and D parameters
- [Medicare.gov Plan Finder](https://www.medicare.gov/plan-compare/): Official plan comparison tool for Part D and Medicare Advantage
- [AARP Medicare Resource Center](https://www.aarp.org/health/medicare-insurance/): Consumer-oriented guides to Medigap standardized plans and enrollment
