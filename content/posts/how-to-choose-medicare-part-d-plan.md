...
faqs:
  - q: "Can I change my Part D plan after I enroll?"
    a: "Yes. Every fall, during the Annual Enrollment Period, which runs October 15 through December 7, you can switch to a different Part D plan. Changes take effect January 1 of the following year. This window exists precisely because your medications and plan formularies both change year to year. I strongly encourage people to run their drug list through the Plan Finder every single fall, even if they're happy with their current plan. Plans can change their formularies, premiums, and tier structures annually."
  - q: "What if my drug isn't on my plan's formulary?"
    a: "You have two main options. You can ask your doctor to file an exception request with the plan, explaining why that specific drug is medically necessary. Plans are required to have an exceptions process. Alternatively, you can ask your doctor whether a therapeutically equivalent drug that is on the formulary might work for you. If neither option works, this is a strong signal that you may want to switch plans at the next enrollment opportunity."
  - q: "Does Part D cover insulin?"
    a: "Yes. Under rules implemented in recent years, many Part D plans are required to cap insulin cost-sharing at $35 per month for covered insulin products. This applies to plans that have signed on to the Senior Savings Model and to plans under the Inflation Reduction Act provisions. Confirm with your specific plan to make sure your insulin brand is covered under these terms."
...
The most powerful free tool available to you is the Medicare Plan Finder at [Medicare.gov](https://www.medicare.gov/). Here's how to actually use it effectively, not just browse it.
...
Yes. Every fall, during the Annual Enrollment Period, which runs October 15 through December 7, you can switch to a different Part D plan. Changes take effect January 1 of the following year. This window exists precisely because your medications and plan formularies both change year to year. I strongly encourage people to run their drug list through the Plan Finder every single fall, even if they're happy with their current plan. Plans can change their formularies, premiums, and tier structures annually.

### What if my drug isn't on my plan's formulary?

You have two main options. You can ask your doctor to file an exception request with the plan, explaining why that specific drug is medically necessary. Plans are required to have an exceptions process. Alternatively, you can ask your doctor whether a therapeutically equivalent drug that is on the formulary might work for you. If neither option works, this is a strong signal that you may want to switch plans at the next enrollment opportunity.

### Does Part D cover insulin?

Yes. Under rules implemented in recent years, many Part D plans are required to cap insulin cost-sharing at $35 per month for covered insulin products. This applies to plans that have signed on to the Senior Savings Model and to plans under the Inflation Reduction Act provisions. Confirm with your specific plan to make sure your insulin brand is covered under these terms.

### What's the difference between a standalone Part D plan and drug coverage through Medicare Advantage?

A standalone Part D plan (PDP) pairs with Original Medicare, Parts A and B, and covers only prescription drugs. A Medicare Advantage Prescription Drug plan (MA-PD) bundles hospital, medical, and drug coverage all in one. If you're on Original Medicare, you need a standalone PDP. If you're on Medicare Advantage, your drug coverage is built into that plan, and you generally cannot also enroll in a separate standalone PDP. Choosing between the two approaches is a bigger decision than just drug coverage, and it's worth getting personalized help.
