...
faqs:
  - q: "Do I have to enroll in Part D if I take no medications right now?"
    a: "Not technically, but I'd strongly recommend enrolling in a low-premium plan anyway. If you go without Part D and later develop a condition that requires expensive medications, you'll face both the Late Enrollment Penalty and a gap until the next Open Enrollment period. A basic plan with a modest premium now protects you from a permanent penalty and gives you immediate coverage if your health changes."
  - q: "Can I use GoodRx or other discount cards instead of Part D?"
    a: "You can use discount cards like GoodRx, but you can't use them at the same time as your Part D coverage. You'd use one or the other for a given prescription. For some very cheap generics, a GoodRx price might actually beat your Part D copay. But using discount cards doesn't count as creditable prescription drug coverage, so if you rely on them instead of enrolling in Part D, you'll face that Late Enrollment Penalty later."
  - q: "What if my doctor prescribes a medication not on my plan's formulary?"
    a: "You have options. Your doctor can request a formulary exception or a prior authorization, explaining why the specific drug is medically necessary. If the plan denies the exception, you have the right to appeal. The appeals process has multiple levels, including an independent review. It takes time and documentation, but many appeals succeed. Your doctor's office can often help initiate the process."
  - q: "Does Part D cover insulin and diabetes supplies?"
...
### Do I have to enroll in Part D if I take no medications right now?

Not technically, but I'd strongly recommend enrolling in a low-premium plan anyway. If you go without Part D and later develop a condition that requires expensive medications, you'll face both the Late Enrollment Penalty and a gap until the next Open Enrollment period. A basic plan with a modest premium now protects you from a permanent penalty and gives you immediate coverage if your health changes.

### Can I use GoodRx or other discount cards instead of Part D?

You can use discount cards like GoodRx, but you can't use them at the same time as your Part D coverage. You'd use one or the other for a given prescription. For some very cheap generics, a GoodRx price might actually beat your Part D copay. But using discount cards doesn't count as creditable prescription drug coverage, so if you rely on them instead of enrolling in Part D, you'll face that Late Enrollment Penalty later.

### What if my doctor prescribes a medication not on my plan's formulary?

You have options. Your doctor can request a formulary exception or a prior authorization, explaining why the specific drug is medically necessary. If the plan denies the exception, you have the right to appeal. The appeals process has multiple levels, including an independent review. It takes time and documentation, but many appeals succeed. Your doctor's office can often help initiate the process.

### Does Part D cover insulin and diabetes supplies?

Yes, with significant improvements in recent years. Under the Inflation Reduction Act, Medicare Part D caps the monthly cost-sharing for covered insulin at $35 per month per prescription, with no deductible applying to insulin. Certain diabetes supplies, like test strips and lancets, are actually covered under Medicare Part B (not Part D), so check which part applies to what you need.

### When can I switch Part D plans outside of Open Enrollment?

Outside of the October 15 to December 7 Open Enrollment window, you can switch in limited circumstances. These include moving to a new address that changes your plan availability, losing other drug coverage, qualifying for Extra Help or losing that qualification, or being enrolled in a Special Needs Plan. There's also a Medicare Advantage Open Enrollment Period from January 1 to March 31, though that applies specifically to Advantage plan changes.
