...
faqs:
  - q: "If I take COBRA, does that protect me from Medicare late enrollment penalties?"
    a: "No, it does not. COBRA is not considered creditable coverage for purposes of avoiding Medicare late enrollment penalties. If you're eligible for Medicare and you take COBRA instead of enrolling, your Initial Enrollment Period continues to run. Missing it without a qualifying exception (like active employer coverage) means permanent premium surcharges."
  - q: "Can I drop COBRA early if I decide to switch to Medicare?"
    a: "Yes. COBRA participants can cancel at any time. There's no penalty for dropping COBRA. If you realize you should have enrolled in Medicare sooner, dropping COBRA and enrolling in Medicare mid-stream is possible, but it won't retroactively fix any late enrollment penalties you've already incurred. Act quickly if you think you've made a mistake."
  - q: "Is COBRA ever a better deal than Medicare?"
    a: "In a few specific situations, yes. If your COBRA plan has very low premiums because your former employer was unusually generous, or if you need coverage for a procedure that's already in process and your providers don't accept Medicare, it might make short-term sense to rely on COBRA. But this is genuinely unusual. For most people turning 65, Medicare plus a Medigap or Advantage plan will offer better long-term value than COBRA alone."
  - q: "What if I don't have Medicare Part A yet when my COBRA starts?"
...
Let me say that again, because this is where people get into trouble: enrolling in COBRA after you leave a job does not give you a Special Enrollment Period for Medicare. It does not pause your Initial Enrollment Period. If you're already 65 (or turning 65 soon) and you take COBRA instead of signing up for Medicare, you may be letting that window close without realizing it.

The late enrollment penalty for Part B (the part that covers doctor visits and outpatient care) is a 10% premium increase for every 12-month period you were eligible but didn't enroll. Those penalties are permanent. If you delayed by three years, your Part B premium goes up 30% for the rest of your life. That's not a hypothetical. I've met people paying it.
...
Some people take both. If you enroll in Medicare Part A and Part B on time, you can also elect COBRA, and COBRA will act as secondary insurance. Medicare pays first, COBRA picks up some of what's left. This combination can significantly reduce your out-of-pocket costs during the COBRA period, which can last up to 18 months (or 29 months in some disability situations, and up to 36 months for dependents).

The catch is that COBRA is expensive. Under federal law, you pay the full premium your employer was paying plus up to 2% in administrative fees. That means if your employer was covering $1,400 a month for your family plan, you could be on the hook for the whole thing. Costs vary enormously by plan and employer, but sticker shock is common.

So the real question isn't "COBRA or Medicare." For most people turning 65, it's "Medicare first, and then do I want to also pay for COBRA as a secondary?" And the honest answer depends on what your COBRA plan costs, what your current healthcare needs look like, and whether you have a Medigap (Medicare Supplement) plan or a Medicare Advantage plan in the mix.

## The One Situation Where COBRA Can Wait (and Medicare Too)

There's an important exception worth knowing. If you're still actively working at 65, and you're covered by your employer's group health plan through that current job (not through COBRA, which is coverage from a previous job), you can delay both Medicare Part B and Part D without penalty. The key word is "actively." Coverage from a current employer counts as creditable coverage. COBRA does not.
...
This is genuinely one of the most confusing areas in all of Medicare, and the [State Health Insurance Assistance Program (SHIP)](https://www.shiphelp.org/) offers free one-on-one counseling specifically designed for situations like this. These are trained volunteers who don't sell insurance and have no stake in what you choose. I'd strongly recommend calling your state's SHIP program before you make any enrollment decisions.
...
Say you're turning 65 and leaving your job. You'll need to sort out Medicare for yourself. But if your spouse is 58 and has been on your employer plan, they don't qualify for Medicare yet. COBRA can cover your spouse for up to 36 months (some qualifying events) or 18 months (others). That buys your spouse time to get to 65, find other coverage, or land a new job with benefits.
...
[AARP's Medicare resource center](https://www.aarp.org/health/medicare-insurance/) has some solid tools for thinking through these family coverage gaps, including how to compare marketplace plans (through Healthcare.gov) to COBRA for younger spouses who might find marketplace coverage cheaper, especially with subsidies.
...
After you've enrolled in Part A and Part B, then you can decide about COBRA. Contact your employer's HR department. You'll receive a COBRA election notice within 14 days of losing coverage, and you have 60 days to decide whether to elect it. You can use COBRA as secondary coverage alongside Medicare, or you can skip COBRA and instead look at Medigap plans or Medicare Advantage.
