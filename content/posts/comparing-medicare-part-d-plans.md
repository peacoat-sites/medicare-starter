---
title: "Comparing Medicare Part D Plans"
...
faqs:
  - q: "Can I switch my Part D plan at any time?"
    a: "Generally, no. The main window for switching standalone Part D plans is Medicare Open Enrollment, which runs October 15 through December 7 each year. Changes take effect January 1. If you have a Medicare Advantage plan with drug coverage, the same window applies, plus there is a Medicare Advantage Open Enrollment Period from January 1 through March 31 where you can switch back to Original Medicare and add a standalone Part D plan."
  - q: "What if my doctor prescribes a drug that's not on my plan's formulary?"
    a: "You have options. Your doctor can request a coverage exception or prior authorization on your behalf, arguing the drug is medically necessary. You can also appeal a coverage denial. If you're in a plan that truly won't cover your medication and the exception process fails, a Special Enrollment Period may apply in some circumstances. In the meantime, you can pay out of pocket or use a discount card like GoodRx, though amounts paid through discount cards don't count toward your Part D out-of-pocket spending."
  - q: "Does my Medicare supplement (Medigap) plan cover prescriptions?"
    a: "No, and this is a common misconception. Medigap policies sold after January 1, 2006 do not cover prescription drugs. If you have Original Medicare with a Medigap supplement, you need a separate standalone Part D plan for drug coverage. If you have Medicare Advantage, drug coverage is typically included in the plan."
  - q: "How does the $2,000 out-of-pocket cap work starting in 2025?"
...
Because private companies run these plans, there is no single "standard" Part D experience. Two people living on the same street, enrolled in plans from the same insurance company, might have wildly different out-of-pocket costs depending on which plan they chose, which drugs they take, and which pharmacies they use.

Part D coverage comes in two forms. You can get it as a standalone Prescription Drug Plan, called a PDP, which layers on top of Original Medicare (Parts A and B). Or you can get it bundled inside a Medicare Advantage plan, often called an MA-PD, which replaces Original Medicare altogether. Both approaches cover prescription drugs, but the rest of your coverage picture looks very different depending on which path you're on. For this article, I'm focused on the comparison process itself, which applies to both.

What surprised me when I went deep on this topic was how often people compare only the monthly premium. That is one of the least useful numbers to focus on in isolation.
...
Here's the real story: there are five cost components that interact with each other, and you have to look at all of them together to understand what a plan will actually cost you.

**1. Monthly premium.** This is what you pay every month regardless of whether you fill any prescriptions. It can range from very low to well over $100 per month depending on your area and the plan.

**2. Annual deductible.** Many plans charge a deductible, meaning you pay the full negotiated cost of your drugs until you've spent a certain amount out of pocket. In 2024, the maximum allowable deductible set by Medicare is $545. Some plans waive the deductible entirely, or waive it for certain drug tiers. If you take a brand-name medication regularly, this number hits hard in January.

**3. Copays and coinsurance by tier.** Every Part D plan organizes drugs into tiers, typically four or five. Tier 1 is usually preferred generics, tier 2 is non-preferred generics, tier 3 is preferred brand-name drugs, and so on up to specialty medications which can carry coinsurance (a percentage of the drug's cost) rather than a flat copay. The plan that looks cheapest on paper may place your specific drug on tier 4 instead of tier 2, which changes everything.
...
**5. Pharmacy network.** Most plans have preferred pharmacies where your copays are lower. If your plan's preferred pharmacy isn't near you, or if you use a mail-order service you prefer, your effective cost changes. Some plans offer $0 copays at preferred pharmacies for generic drugs. Others charge the same whether you use a preferred or non-preferred pharmacy, which might actually be better if flexibility matters to you.

## How to Use Medicare's Plan Finder Tool (Step by Step)

The most powerful free tool available to you is the Medicare Plan Finder at [Medicare.gov](https://www.medicare.gov/). I want to walk you through how to use it properly, because most people only scratch the surface.

**Step 1: Gather your drug list before you start.** Write down the exact name, dosage, and how many pills or doses you take per month for every prescription you take. This includes maintenance medications you might take for granted, like blood pressure or cholesterol drugs.

**Step 2: Go to Medicare.gov and click "Find health & drug plans."** You can search as a guest, but if you log in with your Medicare number, the tool can pre-populate some of your information.
...
**Step 4: Enter every drug from your list.** The tool will search its database. Pay attention to whether your exact dosage and form (tablet vs. capsule, brand vs. generic) is covered under each plan.
...
The research here is genuinely mixed on which mistakes cost people the most money, but from what I've seen, these are the patterns that come up over and over.

**Comparing premiums without checking the formulary.** A $12 monthly premium sounds wonderful until your $300-per-month brand-name medication isn't covered, or sits on tier 5 with 33% coinsurance.

**Ignoring the deductible timing.** If you take an expensive drug, you may blow through a $545 deductible in January before any plan discounts kick in. A plan with a slightly higher premium but no deductible can come out ahead.
...
**Assuming your plan from last year is still the best option.** I cannot stress this enough. Auto-renewal is not the same as re-enrollment with your eyes open. Plans notify you of changes every fall through an Annual Notice of Change (ANOC) document. Most people never read it.
...
Generally, no. The main window for switching standalone Part D plans is Medicare Open Enrollment, which runs October 15 through December 7 each year. Changes take effect January 1. If you have a Medicare Advantage plan with drug coverage, the same window applies, plus there is a Medicare Advantage Open Enrollment Period from January 1 through March 31 where you can switch back to Original Medicare and add a standalone Part D plan.

### What if my doctor prescribes a drug that's not on my plan's formulary?

You have options. Your doctor can request a coverage exception or prior authorization on your behalf, arguing the drug is medically necessary. You can also appeal a coverage denial. If you're in a plan that truly won't cover your medication and the exception process fails, a Special Enrollment Period may apply in some circumstances. In the meantime, you can pay out of pocket or use a discount card like GoodRx, though amounts paid through discount cards don't count toward your Part D out-of-pocket spending.

### Does my Medicare supplement (Medigap) plan cover prescriptions?

No, and this is a common misconception. Medigap policies sold after January 1, 2006 do not cover prescription drugs. If you have Original Medicare with a Medigap supplement, you need a separate standalone Part D plan for drug coverage. If you have Medicare Advantage, drug coverage is typically included in the plan.

### How does the $2,000 out-of-pocket cap work starting in 2025?

This is one of the most significant recent changes to Part D, coming out of the Inflation Reduction Act. Starting in 2025, there's a hard cap of $2,000 on what you pay out of pocket for covered Part D drugs in a calendar year. Once you hit $2,000, your covered drugs cost you nothing for the rest of the year. This eliminates the old "donut hole" coverage gap. It's a major change for people on expensive specialty medications. There's also a new Medicare Prescription Payment Plan that lets you spread your out-of-pocket costs across the year in monthly installments rather than paying large amounts early in the year.

### Is a plan with a 5-star rating always the best choice?

Not necessarily. Star ratings reflect customer service quality, safety measures, and member experience. They don't directly reflect whether a plan's formulary is right for your specific drugs or whether the network includes your pharmacy. A 4-star plan that covers all your medications at a pharmacy two blocks from your house may serve you better than a 5-star plan where your main medication sits on tier 4. Use star ratings as a quality filter, not as the final answer.

---

The annual Open Enrollment window closes December 7, which means most people are either in the middle of this decision right now or wishing they'd paid more attention last fall. If you take away one thing from everything above, let it be this: run your actual drug list through the Medicare Plan Finder before you make any decision. The plan that saves your neighbor $80 a month might cost you $200 more. The comparison only works when it's built around your specific prescriptions, your pharmacy, and your circumstances. If you want help beyond the tool, a State Health Insurance Assistance Program (SHIP) counselor offers free, unbiased guidance in every state. Find yours at Medicare.gov or by calling 1-800-MEDICARE (1-800-633-4227).
