...
Most people get the Medicare-HSA relationship completely backwards. They assume an HSA (Health Savings Account) is just a savings account, so it shouldn't matter what insurance you have. Wrong. The IRS ties HSA eligibility to your health coverage type, not your age or income, and the moment Medicare enters the picture, the rules change fast and without much warning from anyone who should be warning you.

Here's what actually happens: you can't contribute to an HSA once you're enrolled in any part of Medicare. Part A, Part B, doesn't matter which one. Even Part A alone triggers the prohibition. The account doesn't disappear, and the money already in it remains yours to use, but new contributions stop. Permanently, unless you disenroll from Medicare (which is its own complicated mess, and rarely worth it).

I've talked to retirees who kept contributing to their HSA for a year or two after signing up for Medicare, just because nobody told them to stop. The IRS catches it eventually, and the penalty is a 6% excise tax on excess contributions for each year the excess sits there. Not catastrophic, but annoying and entirely avoidable.

## Why Medicare and HSAs Can't Coexist (for Contributions)

The root issue is that HSA eligibility requires enrollment in what the IRS calls a High-Deductible Health Plan, or HDHP. Medicare isn't an HDHP. It's not structured that way, it doesn't qualify under IRS rules, and you can't be enrolled in both an HDHP and Medicare simultaneously. That disqualification is automatic. Not something you opt into or out of.
...
There's an important distinction worth making here: the prohibition is on *contributions*, not on *spending*. Your existing HSA balance can pay for Medicare premiums (Part B, Part D, Medicare Advantage), deductibles, copays, and a wide range of qualified medical expenses. The account keeps working for you; you just can't add to it.
...
The fix: stop HSA contributions at least six months before you plan to claim Social Security. Some advisors push that to the full six months before you turn 65 if you're planning to claim Social Security at 65 right away. The Centers for Medicare & Medicaid Services has information about this on their site, but it's buried and not prominently flagged during enrollment. Worth finding anyway.

## Your Existing HSA Balance Is Actually Valuable in Retirement

People underestimate this. An HSA that's been building for years through employer contributions and your own contributions doesn't just sit there uselessly after Medicare kicks in. It's arguably more useful in retirement than it was during your working years, because qualified medical expenses tend to increase and Medicare still carries real out-of-pocket costs.
