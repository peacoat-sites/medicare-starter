---
title: "CMS Proposed Rule Would Cut Hospital Outpatient Costs for Seniors"
date: 2026-07-12T15:08:56.728591+00:00
draft: false
description: "CMS proposed rule aims to reduce hospital outpatient costs for seniors, potentially lowering out-of-pocket expenses and improving access to affordable healthcar"
image: "/img/heroes/236380.jpg"
categories: ["trending"]
tags: ["proposed", "rule", "would", "hospital", "outpatient"]
author: "Dorothy Chen"
...
slug: "cms-proposed-rule-would-cut-hospital-outpatient-costs-for-seniors"
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Estimated 2027 Medicare savings by policy change</div><div class="sc-row"><span class="sc-label">340B Drug Payment Cut</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">4,850 $M</span></div><div class="sc-row"><span class="sc-label">Site-Neutral Imaging</span><span class="sc-track"><span class="sc-bar" style="width:5%"></span></span><span class="sc-val">260 $M</span></div><div class="sc-src">Source: CMS CY 2027 OPPS Proposed Rule Fact Sheet, July 2, 2026</div></div>


| Policy Change | Who It Affects | Estimated 2027 Savings |
|---|---|---|
...
| Site-neutral off-campus imaging | Hospital outpatient imaging departments | $260 million |
| IPO list removal (637 procedures) | Patients eligible for outpatient surgery | Not separately quantified |
| Net payment rate increase | All OPPS hospitals | +2.4% baseline |
...
- [CMS CY 2027 OPPS/ASC Proposed Rule Fact Sheet](https://www.cms.gov/newsroom/fact-sheets/calendar-year-2027-hospital-outpatient-prospective-payment-system-opps-ambulatory-surgical-center) (July 2, 2026)
- [Holland & Knight: CMS Issues Sweeping CY 2027 Hospital OPPS/ASC Proposed Rule](https://www.hklaw.com/en/insights/publications/2026/07/cms-issues-sweeping-cy-2027-hospital-opps) (July 2026)
- [MedCity News: What to Know About CMS' New Proposed Outpatient Payment Rule](https://medcitynews.com/2026/07/cms-hospital-medicare-payment/) (July 2026)
- [AHA News: CMS Proposes Increases to Medicare Hospital Outpatient Payment Rates](https://www.aha.org/news/headline/2026-07-02-cms-proposes-increases-medicare-hospital-outpatient-department-payment-rates-site-neutral-and-340b) (July 2, 2026)
- [Federal Register: Medicare OPPS and ASC Payment Systems Proposed Rule](https://www.federalregister.gov/documents/2026/07/07/2026-13656/medicare-program-hospital-outpatient-prospective-payment-and-ambulatory-surgical-center-payment) (July 7, 2026)
