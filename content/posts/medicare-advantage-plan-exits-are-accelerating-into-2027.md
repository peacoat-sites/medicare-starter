---
title: "Medicare Advantage Plan Exits Are Accelerating Into 2027"
date: 2026-07-10T16:34:20.113278+00:00
draft: false
description: "Medicare Advantage plan exits are rising heading into 2027. Learn what these changes mean for beneficiaries, coverage options, and how to prepare for open enrol"
image: "/img/heroes/8439679.jpg"
categories: ["trending"]
tags: ["medicare", "advantage", "plan", "exits", "accelerating"]
author: "Susan Park"
...
slug: "medicare-advantage-plan-exits-are-accelerating-into-2027"
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Avg. Medicare Advantage drug plan options per beneficiary</div><div class="sc-row"><span class="sc-label">2024 (peak)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">36 plans</span></div><div class="sc-row"><span class="sc-label">2026</span><span class="sc-track"><span class="sc-bar" style="width:89%"></span></span><span class="sc-val">32 plans</span></div><div class="sc-src">Source: KFF, 2026</div></div>
...
| --- | --- | --- |
| Large national carrier (UHC, Aetna) in a major metro | Lower | Watch for benefit reductions, not exits |
| Regional or smaller carrier in a rural area | Higher | Check if your plan filed for 2027 |
| Vermont or low-density state enrollee | High | Assume nothing; verify now |
| Dual-eligible (Medicare + Medicaid) beneficiary | Variable | Dual Special Needs Plans have different rules |
| Humana enrollee, any market | Moderate-High | Margin pressure is explicit and public |
...
- [Johns Hopkins Bloomberg School of Public Health ,  Forced Disenrollments Among Medicare Advantage Beneficiaries](https://publichealth.jhu.edu/2026/1-in-10-medicare-advantage-enrollees-face-forced-disenrollment-in-2026) (published February 20, 2026)
- [AJMC ,  Unprecedented Spike in Plan Exits Threatens Medicare Advantage Stability](https://www.ajmc.com/view/unprecedented-spike-in-plan-exits-threatens-medicare-advantage-stability) (published June 2, 2026)
- [AHIP ,  Proposed Changes to Medicare Advantage and Part D Would Impact Seniors in 2027](https://www.ahip.org/news/articles/if-finalized-proposed-changes-to-medicare-advantage-and-medicare-part-d-would-impact-seniors-coverage-and-care-in-2027) (published March 2, 2026)
- [KFF ,  Most Medicare Beneficiaries Affected by Plan Terminations in 2025 Have Options in 2026](https://www.kff.org/medicare/most-medicare-beneficiaries-affected-by-plan-terminations-in-2025-have-robust-medicare-advantage-options-in-2026/) (published March 13, 2026)
- [LeadGen Economy ,  Medicare Advantage 2026 AEP Carrier Exits: UHC, Humana, and Aetna](https://www.leadgen-economy.com/blog/medicare-advantage-2026-aep-carrier-exits-uhc-humana-aetna/) (published June 26, 2026)
