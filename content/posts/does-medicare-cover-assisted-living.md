---
title: "Medicare and Assisted Living: Coverage Facts You Need"
date: 2026-07-14T15:39:26.756459+00:00
draft: false
description: "Learn what Medicare covers for assisted living costs, eligibility requirements, and alternative payment options to help plan your care."
image: "/img/heroes/16364306.jpg"
categories: ["Does Medicare Cover"]
tags: ["does", "medicare", "cover", "assisted", "living"]
author: "Nancy Davis"
...
faqs:
  - q: "Does Medicare ever pay for any part of assisted living?"
    a: "Almost never. Medicare doesn't cover room and board or custodial care in assisted living settings. It might pay for a specific skilled service, like a physical therapist visiting the facility, but it won't pay for the facility itself."
  - q: "What's the difference between assisted living and a skilled nursing facility for Medicare purposes?"
    a: "A skilled nursing facility (SNF) provides medically necessary, licensed clinical care after a qualifying hospital stay. Medicare Part A can cover SNF care under strict conditions for up to 100 days. Assisted living is primarily a residential, custodial setting, which Medicare excludes entirely."
  - q: "Can Medicaid pay for assisted living?"
    a: "Yes, in many states, though the rules vary significantly. Medicaid waiver programs in 36 states can cover some assisted living costs for people who meet income and asset limits. Waiting lists are common. Contact your state's Medicaid office or your local SHIP counselor (find them at Medicare.gov) to check what's available where you live."
  - q: "Does long-term care insurance cover assisted living?"
    a: "Most policies issued in the last 20 years do, provided you meet the benefit trigger, typically needing help with two or more activities of daily living. Read your specific policy carefully; older policies from the 1980s and 1990s sometimes required nursing home placement to activate benefits."
  - q: "At what point does Medicare cover nursing home care?"
    a: "Medicare Part A covers care in a certified skilled nursing facility only after a qualifying inpatient hospital stay of at least 3 consecutive days, and only when you need skilled nursing or therapy services. It covers 100% of costs for the first 20 days, then requires a daily coinsurance payment through day 100, after which coverage ends."
---
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Average annual assisted living cost by state (2026)</div><div class="sc-row"><span class="sc-label">California</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$72,000</span></div><div class="sc-row"><span class="sc-label">Florida</span><span class="sc-track"><span class="sc-bar" style="width:62%"></span></span><span class="sc-val">$45,000</span></div><div class="sc-row"><span class="sc-label">Texas</span><span class="sc-track"><span class="sc-bar" style="width:60%"></span></span><span class="sc-val">$43,200</span></div><div class="sc-row"><span class="sc-label">New York</span><span class="sc-track"><span class="sc-bar" style="width:82%"></span></span><span class="sc-val">$58,800</span></div><div class="sc-row"><span class="sc-label">Ohio</span><span class="sc-track"><span class="sc-bar" style="width:58%"></span></span><span class="sc-val">$42,000</span></div><div class="sc-row"><span class="sc-label">Arizona</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">$48,000</span></div><div class="sc-src">Source: Genworth Cost of Care Survey 2025</div></div>
...
According to the Genworth Cost of Care Survey (one of the most consistently reliable data sources on this, current as of July 2026), the national median monthly cost for assisted living is about $5,350, or roughly $64,200 a year. That's the middle of the road. In California's coastal markets, you can easily spend $7,000 to $8,500 a month. In rural Ohio or rural Kansas, you might find $3,200 a month, though those facilities vary enormously in quality and services.

Here's what that looks like across care types:

| Care Type | Who Pays (Typically) | Medicare Coverage | Average Monthly Cost (2026) |
|---|---|---|---|
| Assisted Living | Private pay, long-term care insurance, Medicaid (in some states) | None | $4,500–$7,500 |
| Memory Care (Dementia) | Private pay, long-term care insurance, Medicaid (limited) | None | $5,500–$9,000 |
| Skilled Nursing Facility | Medicare (short-term, post-hospital), Medicaid (long-term) | Yes, with strict conditions | $8,000–$12,000 |
| Home Health Aide | Medicare (skilled care component only), private pay | Partial, skilled visits only | $25–$35/hour |
| Adult Day Services | Private pay, Medicaid waiver programs | No | $80–$120/day |
...
If you want to research your plan options yourself, [Medicare.gov](https://www.medicare.gov/) has a plan comparison tool that shows exactly what supplemental benefits each plan in your area covers. Worth spending 20 minutes on before you assume anything.

## Sources

- [Genworth Cost of Care Survey (2025)](https://www.genworth.com/aging-and-you/finances/cost-of-care.html): Annual survey of long-term care costs by setting and state across the U.S.
- [Kaiser Family Foundation (2023)](https://www.kff.org/medicare/): Survey data on Medicare beneficiary understanding of long-term care coverage
- [Medicare.gov](https://www.medicare.gov/): Official CMS resource for coverage rules, skilled nursing facility criteria, and plan comparison tools
- [AARP Medicare Resource Center](https://www.aarp.org/health/medicare-insurance/): Plain-language explainers on Medicare coverage limits and long-term care planning
- [Medicaid.gov HCBS Waiver Information](https://www.medicaid.gov/medicaid/home-community-based-services/index.html): State-by-state data on Home and Community Based Services waiver programs
