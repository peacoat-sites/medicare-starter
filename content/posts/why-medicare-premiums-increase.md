---
title: "Why Medicare Premiums Increase Every Year"
date: 2026-08-10T15:11:05.878933+00:00
draft: false
description: "Understanding the factors behind rising Medicare costs, from healthcare inflation to policy changes. Learn what drives your premium increases."
image: "/img/heroes/8123820.jpg"
categories: ["Medicare Costs"]
tags: ["medicare", "premiums", "increase"]
author: "Nancy Davis"
...
slug: "why-medicare-premiums-increase"
affiliate_disclosure: true
faqs:
  - q: "Why did my Medicare premium go up even though my income didn't change?"
    a: "Part B premiums are adjusted annually based on projected Medicare program spending, not your personal income. Even if nothing changed in your financial life, higher projected costs across the Medicare program will raise everyone's base premium. The standard Part B premium has increased most years for the last decade."
  - q: "What is IRMAA and how do I know if it applies to me?"
    a: "IRMAA stands for Income-Related Monthly Adjustment Amount, and it's an additional surcharge on top of your regular Part B and Part D premiums. It applies if your Modified Adjusted Gross Income from two years ago exceeded $106,000 (individual) or $212,000 (joint). You'll receive a letter from Social Security if you're subject to IRMAA; it doesn't arrive as a surprise on your bill."
  - q: "Can I appeal a Medicare premium increase?"
    a: "You can appeal an IRMAA surcharge if your income has dropped due to a qualifying life event (retirement, divorce, death of a spouse, etc.). File Form SSA-44 with your local Social Security office. You can't appeal the base Part B premium increase, as that's set program-wide."
  - q: "Does Medicare Part A have a premium that increases too?"
    a: "Most people don't pay a Part A premium if they (or a spouse) worked and paid Medicare taxes for at least 40 quarters (about 10 years). Those who do pay a Part A premium will see it adjust annually alongside Part B. The Part A deductible, which applies to hospital stays, does increase most years and currently stands at $1,676 per benefit period in 2026."
  - q: "Will my Medicare Advantage plan premium increase?"
    a: "It can, and it happens more often than people expect. Medicare Advantage plan premiums are set by private insurers and can change every year during open enrollment. Your current plan is required to notify you of changes before October 15, giving you the window to switch if the new terms don't work for you. Don't ignore that Annual Notice of Change letter when it arrives in September."
---
...
Medicare premiums go up for several distinct reasons, and they don't all apply to every person equally. Some increases are universal. Some land only on higher earners. A few are avoidable with the right planning. The [difference between](/difference-between-medicare-and-medicaid-explained/) understanding this and not understanding it can be several hundred dollars a year.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Part B premiums are set annually by CMS and tend to increase most years, often tied to projected healthcare spending.</li><li style="margin:5px 0">Higher-income beneficiaries pay IRMAA surcharges on top of base premiums, up to $628.90/month for Part B in 2026 for top earners.</li><li style="margin:5px 0">A two-year income lookback means a good year financially can raise your Medicare bill today.</li><li style="margin:5px 0">Part D (prescription drug) premiums vary by plan and also carry income surcharges for higher earners.</li><li style="margin:5px 0">You can appeal an IRMAA increase if your income dropped due to a qualifying life event.</li></ul></div>


## The Mechanics Behind the Annual Increase

[Medicare Part](/medicare-part-c-explained/) B covers outpatient care, doctor visits, and most preventive services. Its standard monthly premium is set each fall by the Centers for Medicare & Medicaid Services (CMS) for the following year, based on projected costs across the entire Medicare program.

The formula is anchored in law: Part B is designed so that premiums cover roughly 25% of program costs, with general federal revenue covering the rest. When projected spending goes up, your premium follows. CMS looks at things like new drug approvals, physician fee schedule changes, and [hospital outpatient costs](/cms-proposed-rule-would-cut-hospital-outpatient-costs-for-seniors/). If an expensive new treatment becomes widely used, it genuinely affects what everyone pays.
...
Income-Related Monthly Adjustment Amounts (IRMAA, pronounced "er-MAH") are premium surcharges added on top of your base Part B and Part D premiums if your income exceeds certain thresholds. This is where a lot of seniors get blindsided, and I've seen it happen to careful, informed people who just didn't know how far back Medicare looks.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">2026 Monthly Part B Premium by Income Bracket</div><div class="sc-row"><span class="sc-label">Base (&lt;$106k)</span><span class="sc-track"><span class="sc-bar" style="width:29%"></span></span><span class="sc-val">$185</span></div><div class="sc-row"><span class="sc-label">Tier 1 ($106k-$133k)</span><span class="sc-track"><span class="sc-bar" style="width:41%"></span></span><span class="sc-val">$259</span></div><div class="sc-row"><span class="sc-label">Tier 2 ($133k-$167k)</span><span class="sc-track"><span class="sc-bar" style="width:59%"></span></span><span class="sc-val">$370</span></div><div class="sc-row"><span class="sc-label">Tier 3 ($167k-$200k)</span><span class="sc-track"><span class="sc-bar" style="width:76%"></span></span><span class="sc-val">$480.9</span></div><div class="sc-row"><span class="sc-label">Tier 4 ($200k-$500k)</span><span class="sc-track"><span class="sc-bar" style="width:94%"></span></span><span class="sc-val">$591.9</span></div><div class="sc-row"><span class="sc-label">Tier 5 (&gt;$500k)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$628.9</span></div><div class="sc-src">Source: CMS 2026 Medicare IRMAA Schedule</div></div>


## You Can Fight an IRMAA Increase

This is the part most people miss entirely because it's buried in CMS documentation and your Medicare Summary Notice certainly doesn't highlight it.
...
Scenario: Retired teacher, age 67, sold an investment property in 2024 for a $180,000 gain → income pushed into the fourth IRMAA tier → filed SSA-44 in February 2026 documenting retirement in 2025 with pension income of $38,000 → IRMAA surcharge removed retroactively → recovered approximately $2,900 in overpaid premiums.
...
Medicare Advantage (Part C) plans work differently: the base Part B premium still applies, but many Advantage plans have their own monthly premium on top (sometimes zero, sometimes $50 or more), and that can change year to year. The State Health Insurance Assistance Program (SHIP) at [shiphelp.org](https://www.shiphelp.org/) offers free one-on-one counseling to help you compare your options, and they don't sell anything, which matters.
...
Scenario: Two neighbors, both on Medicare. One receives Social Security; Part B deducted automatically → protected by hold-harmless in a low-COLA year, premium increase capped → premium rises $6/month. The other is 64, pays Part B directly because she deferred Social Security → no protection → premium rises the full amount → pays $22/month more than her neighbor for identical coverage.

Same Medicare. Different rules. That asymmetry bothers people when they discover it, and reasonably so.

## Sources

- [CMS Medicare Costs](https://www.medicare.gov/basics/costs/medicare-costs): Official 2026 premium, deductible, and coinsurance amounts from Medicare.gov.
- [Social Security Administration, Form SSA-44](https://www.ssa.gov/forms/ssa-44.pdf): The official form for requesting IRMAA reconsideration based on a life-changing event.
- [CMS IRMAA Determination](https://www.cms.gov/Medicare/Health-Plans/MedicareAdvtgSpecRateStats/Ratebooks-and-Supporting-Data): CMS documentation on income-related premium adjustments.
- [SHIP National Technical Assistance Center](https://www.shiphelp.org/): Free Medicare counseling resources by state.
- Kaiser Family Foundation Medicare Policy Research (2025): Annual analyses of Medicare premium trends and beneficiary cost burdens.
