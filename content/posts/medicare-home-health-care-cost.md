---
title: "Medicare Home Health Care Costs: What You'll Actually Pay"
date: 2026-07-14T15:41:16.771103+00:00
draft: false
description: "Understand Medicare home health care coverage, out-of-pocket costs, and eligibility requirements. Get answers to common questions about home care expenses."
image: "/img/heroes/8949828.jpg"
categories: ["Medicare Costs"]
tags: ["medicare", "home", "health", "care", "cost"]
author: "Dorothy Chen"
...
slug: "medicare-home-health-care-cost"
affiliate_disclosure: true
faqs:
  - q: "Does Medicare pay for 24-hour home care?"
    a: "No. Medicare covers only intermittent skilled care, meaning a few hours on a few days per week, not continuous daily care. Around-the-clock care is private pay unless Medicaid or a long-term care insurance policy covers it."
  - q: "How long will Medicare pay for home health services?"
    a: "There's no fixed episode limit, but coverage requires ongoing skilled need and homebound status. Once your doctor certifies the skilled need has resolved, Medicare coverage ends. Episodes are reviewed regularly, and 'maintenance therapy' can qualify if a skilled professional is needed to maintain function, not just a caregiver."
  - q: "What's the difference between a home health aide and a homemaker?"
    a: "A home health aide assists with personal care: bathing, dressing, grooming, and sometimes medication reminders. A homemaker handles household tasks like cooking, cleaning, and errands. Medicare can cover aide visits alongside skilled care. It never covers homemaker services."
  - q: "Can I hire a home health aide privately instead of through an agency?"
    a: "Yes, and it's usually cheaper. But you become the employer of record, responsible for payroll taxes, workers' compensation, backup coverage when the person is sick, and liability if something goes wrong. For families who find a trustworthy person, it can work well. Going in without understanding those obligations is where it gets messy."
  - q: "Will my Medigap (supplement) plan cover home care costs Medicare doesn't pay?"
    a: "Standard Medigap plans cover Medicare's cost-sharing (deductibles, copays) but don't extend Medicare's coverage categories. If Medicare won't pay for a service, Medigap won't either. The only exception is long-term care insurance, which is a separate product entirely."
---
...
Current as of July 2026, here's what you're actually looking at when Medicare's coverage runs out or doesn't apply.


<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Median annual home care cost by service type (2026)</div><div class="sc-row"><span class="sc-label">Homemaker Services</span><span class="sc-track"><span class="sc-bar" style="width:57%"></span></span><span class="sc-val">$61,400</span></div><div class="sc-row"><span class="sc-label">Home Health Aide</span><span class="sc-track"><span class="sc-bar" style="width:63%"></span></span><span class="sc-val">$68,600</span></div><div class="sc-row"><span class="sc-label">Adult Day Care</span><span class="sc-track"><span class="sc-bar" style="width:21%"></span></span><span class="sc-val">$22,880</span></div><div class="sc-row"><span class="sc-label">Assisted Living</span><span class="sc-track"><span class="sc-bar" style="width:59%"></span></span><span class="sc-val">$64,200</span></div><div class="sc-row"><span class="sc-label">Nursing Home (private)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$108,405</span></div><div class="sc-src">Source: Genworth Cost of Care Survey (2026 estimates)</div></div>
...
- [Medicare.gov Home Health Coverage](https://www.medicare.gov/coverage/home-health-services): Official CMS coverage rules and eligibility criteria
- [Genworth Cost of Care Survey](https://www.genworth.com/aging-and-you/finances/cost-of-care.html): Annual survey of home care, assisted living, and nursing facility costs by state and city
- [CMS Home Health Quality Reporting Program](https://www.cms.gov/Medicare/Quality-Initiatives-Patient-Assessment-Instruments/HomeHealthQualityInits): Source for agency-level outcome data published on Care Compare
- [SHIP National Network (shiphelp.org)](https://www.shiphelp.org/): Free Medicare counseling directory by state
