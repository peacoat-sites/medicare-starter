...
slug: "medicare-for-disabled-people"
affiliate_disclosure: true
faqs:
  - q: "Can I get Medicare if I'm disabled but haven't worked enough to qualify for SSDI?"
    a: "It depends. If you have ESRD or ALS, you can qualify regardless of your work history. Otherwise, Medicare eligibility for people under 65 is tied to receiving SSDI, which requires sufficient work credits. If you don't qualify for SSDI, Medicaid may be a better option, and your state agency can help you apply."
  - q: "Does Medicare cover wheelchairs, walkers, and other medical equipment for disabled people?"
    a: "Yes. Durable Medical Equipment (DME) is covered under Medicare Part B, including wheelchairs, power scooters, walkers, hospital beds used at home, and similar items, as long as your doctor certifies the medical necessity and you use a Medicare-approved supplier. You typically pay 20% of the Medicare-approved amount after your Part B deductible."
  - q: "What happens to my Medicare if I go back to work?"
    a: "You don't lose it right away. The Trial Work Period lets you test employment for up to 9 months without affecting your benefits. After that, Medicare can continue for up to 93 months even if your SSDI cash payments stop. Contact the SSA directly to understand how your specific situation is affected before making any work decisions."
  - q: "Can a disabled person under 65 buy a Medigap supplement plan?"
...
Two years is a long time to go without coverage. Here's what I tell people who are in that gap: your options depend heavily on your situation, but there are real paths.
...
The Extra Help program (also called the Low Income Subsidy, or LIS) helps pay Part D premiums, deductibles, and copays for people with limited income and resources. The [Centers for Medicare & Medicaid Services](https://www.cms.gov/) reports that millions of people who qualify for Extra Help never apply. That's not a knock on anyone. People don't know it exists.
...
[AARP's Medicare resource center](https://www.aarp.org/health/medicare-insurance/) has a solid breakdown of these programs if you want to dig in before talking to someone.
...
- [Social Security Administration: Disability Benefits and Medicare](https://www.ssa.gov/benefits/medicare/): Official SSA guidance on how SSDI recipients become Medicare eligible, including the 24-month waiting period and exceptions for ALS and ESRD.
- [Centers for Medicare & Medicaid Services: Medicare & You Handbook](https://www.medicare.gov/medicare-and-you): The official annual Medicare handbook, current as of 2026, covering all parts and enrollment rules.
- [CMS: Medicare Savings Programs](https://www.medicare.gov/basics/costs/help/medicare-savings-program): State-by-state resource on income-based programs that help cover Medicare premiums and cost-sharing.
- [Social Security Administration: Ticket to Work Program](https://www.ssa.gov/work/): Information on the Trial Work Period and Extended Period of Eligibility for disabled beneficiaries who want to return to work.
- [AARP Medicare Resource Center](https://www.aarp.org/health/medicare-insurance/): Plain-language guides on Medicare eligibility, Extra Help, and coverage options for people with disabilities.
