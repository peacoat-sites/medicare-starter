...
The [State Health Insurance Assistance Program (SHIP)](https://www.shiphelp.org/) can connect you with a free local counselor who'll go through all of this with you at no charge. I genuinely can't recommend SHIP enough. These are trained volunteers with no financial stake in what you choose.
...
Fourth: manufacturer patient assistance programs. If you're on an expensive brand-name drug that has no generic, the manufacturer may have a program to reduce your out-of-pocket cost, even if you have Medicare. NeedyMeds.org is a good place to start searching. [AARP's Medicare resource center](https://www.aarp.org/health/medicare-insurance/) also maintains a helpful guide on drug cost reduction strategies.
...
- [Medicare.gov Plan Finder](https://www.medicare.gov/plan-compare/): Official tool for comparing Medicare Advantage, Part D, and Medigap plans by location and drug needs.
- [Social Security Administration, Extra Help Program](https://www.ssa.gov/medicare/part-d-extra-help): Details on the Low Income Subsidy for Part D costs, including eligibility and application.
- [Centers for Medicare & Medicaid Services (CMS), Medicare Savings Programs](https://www.medicare.gov/basics/costs/help/medicare-savings-programs): Overview of state programs that can reduce Part B and other Medicare costs.
- [AARP Medicare Resource Center](https://www.aarp.org/health/medicare-insurance/): Consumer-focused guidance on plan types, drug costs, and financial assistance programs.
- [State Health Insurance Assistance Program (SHIP) National Network](https://www.shiphelp.org/): Free, unbiased Medicare counseling through state-based volunteer counselors.
