---
title: "Medicare Durable Medical Equipment: What Gets Covered"
date: 2026-07-11T15:10:30.781545+00:00
draft: false
description: "Learn which durable medical equipment Medicare covers, how to qualify, what you pay, and how to find Medicare-approved suppliers near you."
image: "/img/heroes/6010887.jpg"
categories: ["Medicare Costs"]
tags: ["medicare", "durable", "medical", "equipment", "coverage"]
author: "Nancy Davis"
...
slug: "medicare-durable-medical-equipment-coverage"
affiliate_disclosure: true
faqs:
  - q: "Does Medicare cover a lift chair recliner?"
    a: "Medicare covers only the lifting mechanism of a seat-lift chair, not the chair itself, if your doctor certifies it's medically necessary. Typically Medicare pays 80% of the approved amount for the mechanism portion only, which is usually a fraction of the total chair price."
  - q: "What if my DME claim is denied?"
    a: "You have the right to appeal. The denial letter from Medicare or your plan will include deadlines and instructions. Don't ignore it. A significant portion of denials are overturned on appeal, especially when additional documentation from your doctor is submitted. Contact 1-800-MEDICARE (1-800-633-4227) or your State Health Insurance Assistance Program (SHIP) for free help."
  - q: "Can Medicare cover two pieces of the same equipment, like two CPAP machines?"
    a: "Generally no, not at the same time. Medicare won't pay for duplicate equipment while a covered item is still functional. If your CPAP is lost, stolen, or irreparably damaged, you can request replacement, but you'll need to document the circumstances."
  - q: "Does Medicare cover equipment I buy from Amazon or a retail store?"
    a: "Only if that retailer is enrolled as a Medicare supplier and you follow all the ordering and documentation rules. Many online retailers are not Medicare-enrolled suppliers. Check Medicare.gov's supplier directory first, or you risk paying the full amount yourself."
  - q: "How long does Medicare rent DME before buying it outright?"
    a: "For capped rental items (like standard wheelchairs and hospital beds), Medicare rents for up to 13 months, after which ownership typically transfers to you. For oxygen equipment, Medicare pays rental for 36 months, after which the supplier must continue providing the equipment and certain maintenance at no additional rental charge for as long as it's medically necessary."
---
...
Here's the honest picture on what you'll pay. Once your Part B deductible is met ($257 in 2026, per the Centers for Medicare & Medicaid Services), Medicare generally pays 80% of the approved amount for covered DME. You're responsible for the remaining 20%, and that 20% has no cap under Original Medicare. On a $6,000 power wheelchair, 20% is $1,200 out of pocket, just like that.

| Equipment Type | Typical Medicare-Approved Amount | Your 20% Share (Approximate) | Notes |
|---|---|---|---|
| Standard manual wheelchair | $100–$200/month (rental) or purchase | $20–$40/mo or ~$100–$200 purchase | Often rented first, then purchase option |
| Power wheelchair / scooter | $1,500–$6,000+ (purchase) | $300–$1,200+ | Requires extensive documentation |
| CPAP machine | $400–$800 | $80–$160 | Supplies billed separately monthly |
| Home oxygen equipment | Rented monthly; approx. $180–$350/mo | $36–$70/mo | Medicare pays rental up to 36 months |
| Hospital bed | $100–$400/mo rental | $20–$80/mo | Usually rented, not purchased |
| Blood glucose monitor | $30–$75 (device) | $6–$15 | Test strips are a separate DME billing category |
| Nebulizer | $30–$70 | $6–$14 | Medication billed separately under Part D |
...
This is where I get a little protective on your behalf, because the supplier issue trips up even careful people.
...
Patient with post-stroke hemiplegia needs a power wheelchair → Physician documents inability to self-propel a manual chair, PT performs evaluation, CMN completed correctly → Medicare approves, patient pays approximately $900 on a $4,500 chair after 20% coinsurance.

Diabetic patient needs a blood glucose monitor and test strips → Primary care doctor writes a prescription and notes insulin-dependent status → Medicare covers the monitor and up to 300 test strips per 3 months; patient pays roughly $15 out of pocket total after deductible.

COPD patient needs home oxygen → Pulmonologist orders oxygen with documented oxygen saturation of 88% or below (the threshold Medicare requires) → Medicare covers monthly rental; if patient improves above saturation threshold within 12 months, coverage can be discontinued.
...
- [Medicare.gov DME coverage page](https://www.medicare.gov/coverage/durable-medical-equipment-dme-coverage): Official coverage rules, supplier lookup tool, and CBA information, current as of July 2026.
- [Centers for Medicare & Medicaid Services (CMS)](https://www.cms.gov/): 2026 Part B deductible figures, competitive bidding program details, and CMN requirements.
- [CMS Competitive Bidding Program documentation](https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/DMEPOSCompetitiveBid): Lists of CBAs and contract suppliers by equipment category.
- [Medicare & You 2026 Handbook](https://www.medicare.gov/publications/10050-medicare-and-you.pdf): Official annual handbook covering DME cost-sharing and enrollment rules.
