---
title: "Traditional Medicare WISeR Pilot Is Having a Rocky Start"
date: 2026-08-11T15:11:28.433947+00:00
draft: false
description: "Traditional Medicare WISeR Pilot faces early challenges in implementation. Learn about the obstacles affecting this healthcare initiative and what's next for be"
image: "/img/heroes/6129454.jpg"
categories: ["trending"]
tags: ["traditional", "medicare", "wiser", "pilot", "having"]
author: "Dorothy Chen"
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">WISeR launched January 1, 2026, covering 6.4 million traditional Medicare beneficiaries in 6 states.</li><li style="margin:5px 0">The pilot applies AI-assisted prior authorization to 17 outpatient procedures through December 31, 2031.</li><li style="margin:5px 0">As of mid-2026, documented cases include AI denials and long waits for peer-to-peer physician review.</li><li style="margin:5px 0">Beginning July 2026, CMS introduced "gold carding" to exempt high-performing physicians from prior authorization.</li><li style="margin:5px 0">42 Democratic members of Congress formally challenged the pilot in a July 31, 2026 letter to CMS Administrator Dr. Mehmet Oz.</li></ul></div>


## What Procedures Are Actually Affected

This is usually the first question people ask. Not every service [requires prior authorization](/original-medicare-now-requires-prior-authorization-in-six-states/) under WISeR. The pilot targets 17 specific outpatient procedures that CMS has flagged as potentially overused. The list includes some treatments that are quite common among older adults, which is part of why the backlash has been so sharp.

| Procedure Category | Examples Covered Under WISeR |
| --- | --- |
| Spine treatments | Epidural steroid injections, cervical fusion |
| Neurological | Deep brain stimulation for Parkinson's disease |
| Joint care | Knee osteoarthritis treatments |
...
- [Medicare's prior authorization experiment is off to a rocky start](https://finance.yahoo.com/healthcare/article/medicares-prior-authorization-experiment-is-off-to-a-rocky-start-121019353.html) (June 23, 2026)
- [New report: Medicare WISeR prior authorization pilot program causing care delays](https://www.risehealth.org/insights-articles/article/new-report-medicare-wiser-prior-authorization-pilot-program-causing-care-delays/) (July 2026)
- [Medicare prior authorization pilot raises concerns among providers](https://www.healthcaredive.com/news/medicare-prior-authorization-pilot-worries-providers-cmmi-wiser/760133/) (August 2026)
- [WISeR and Medicare Advantage Prior Authorization: What's Changing in 2026](https://www.adsc.com/blog/wiser-and-medicare-advantage-prior-authorization) (October 2025)
- [Does Medicare Require Prior Authorization?](https://www.goodrx.com/insurance/medicare/does-medicare-require-prior-authorization) (Updated July 29, 2026)
- [Medicare's New Prior Approval Pilot ,  What You Need to Know](https://time.com/7313351/medicare-prior-authorization-pilot-states-concerns/) (2026)
