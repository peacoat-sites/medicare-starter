---
title: "Medicare Medicaid Coordination by State: Key Coverage Differences"
date: 2026-07-17T15:23:54.697784+00:00
draft: false
description: "Learn how Medicare and Medicaid coordination varies by state, including eligibility rules, coverage gaps, and enrollment requirements for dual-eligible benefici"
image: "/img/heroes/7821684.jpg"
categories: ["State Medicare Resources"]
tags: ["medicare", "medicaid", "coordination", "state"]
...
slug: "medicare-medicaid-coordination-by-state"
affiliate_disclosure: true
faqs:
  - q: "What does 'dually eligible' mean and how do I know if I qualify?"
    a: "Dually eligible means you're enrolled in both Medicare and Medicaid at the same time. You likely qualify if you're on Medicare and your monthly income is below roughly $1,255 (for the most comprehensive benefits) or up to around $1,660 for premium-only help. Asset limits also apply, though many states have raised or eliminated them. Your state Medicaid agency can confirm in one phone call."
  - q: "Does Medicaid cover what Medicare doesn't, like dental and vision?"
    a: "It depends entirely on your state. Federal law doesn't require state Medicaid programs to cover dental or vision for adults, but many states do offer these benefits for dual-eligible seniors, especially if you're enrolled in a D-SNP. California and New York are among the more generous states; others offer very little. Always ask your state Medicaid office what's specifically available for dually eligible adults."
  - q: "Can providers still bill me if I'm a QMB?"
    a: "No. If you're enrolled in the Qualified Medicare Beneficiary program, federal law prohibits providers who accept Medicare from billing you for Medicare cost-sharing amounts (deductibles, copays, coinsurance). If you receive a bill, don't ignore it. Call 1-800-MEDICARE and report the provider. You're entitled to a refund."
  - q: "How do I enroll in a Medicare Savings Program?"
    a: "You apply through your state Medicaid agency, not through Medicare or Social Security directly. The application is usually a few pages and requires proof of income and residency. Processing times vary, but many states complete them within 30 to 45 days. In some states, enrolling in Medicaid automatically screens you for MSPs. Your local SHIP counselor can walk you through the paperwork at no charge."
  - q: "Is a D-SNP better than keeping Original Medicare with Medicaid as a supplement?"
    a: "For most dual-eligible people with complex health needs, yes, an integrated D-SNP is usually the better choice because it coordinates care between both programs and often adds extra benefits. But it's not universal. If you have a specialist you love who isn't in any D-SNP network in your area, or if you travel frequently and need nationwide coverage, Original Medicare may work better for your situation. Check plan availability at Medicare.gov's plan finder before deciding."
---
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">About 12.5 million Americans are dually eligible for both Medicare and Medicaid as of 2026.</li><li style="margin:5px 0">Medicare always pays first; Medicaid picks up remaining costs as the "payer of last resort."</li><li style="margin:5px 0">D-SNPs (Dual Eligible Special Needs Plans) are available in most states and often add dental, vision, and hearing benefits.</li><li style="margin:5px 0">State Medicaid income and asset limits vary widely, some states are far more generous than others.</li><li style="margin:5px 0">A free SHIP (State Health Insurance Assistance Program) counselor can help you claim benefits you're missing.</li></ul></div>


## How the Two Programs Are Supposed to Work Together

The basic rule isn't complicated: Medicare pays first, and Medicaid pays second. If you have [Original Medicare](/can-i-switch-from-medicare-advantage-back-to-original-medicare/) (Parts A and B), Medicare handles your hospital and medical bills, and Medicaid steps in to cover what Medicare doesn't, including copays, deductibles, and sometimes services Medicare doesn't cover at all, like long-term care, dental, or transportation to appointments.

That "payer of last resort" rule is federal law. Medicaid cannot pay a claim before [Medicare has](/traditional-medicare-has-no-spending-cap-a-new-bill-would-change-that/) processed it. This sounds straightforward but in practice, billing errors happen constantly. Providers sometimes bill Medicaid directly and skip Medicare entirely, which can create denials and delays. If you ever get a bill that looks wrong, ask your provider's billing office which insurer they submitted to first. You'd be surprised how often the answer is "just Medicaid."
...
| MSP Level | What It Covers | Monthly Income Limit (Individual, 2026 approximate) |
|---|---|---|
...
*Note: These are approximate federal benchmarks. States set their own limits and some are more generous. Confirm your state's current figures at [Medicare.gov](https://www.medicare.gov) or with your state Medicaid office.*

The QMB level is the one that shocks people when they discover it. If you qualify, providers are literally prohibited by federal law from billing you for [Medicare cost](/medicare-cost-for-low-income-seniors/)-sharing. Not "they probably won't bill you." They cannot. I've seen cases where a QMB enrollee was billed anyway, disputed it, and got a full refund. If that happens to you, call 1-800-MEDICARE and report it.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">State Medicaid dental benefit generosity for dual-eligibles (estimated annual benefit valu</div><div class="sc-row"><span class="sc-label">California</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$1,800</span></div><div class="sc-row"><span class="sc-label">New York</span><span class="sc-track"><span class="sc-bar" style="width:83%"></span></span><span class="sc-val">$1,500</span></div><div class="sc-row"><span class="sc-label">Texas</span><span class="sc-track"><span class="sc-bar" style="width:22%"></span></span><span class="sc-val">$400</span></div><div class="sc-row"><span class="sc-label">Florida</span><span class="sc-track"><span class="sc-bar" style="width:33%"></span></span><span class="sc-val">$600</span></div><div class="sc-row"><span class="sc-label">Wyoming</span><span class="sc-track"><span class="sc-bar" style="width:11%"></span></span><span class="sc-val">$200</span></div><div class="sc-row"><span class="sc-label">Ohio</span><span class="sc-track"><span class="sc-bar" style="width:50%"></span></span><span class="sc-val">$900</span></div><div class="sc-src">Source: KFF Medicaid Benefits Survey 2026 estimates</div></div>
...
The problem is availability. FIDE-SNPs exist in fewer than 20 states as of this year, and even within those states, not every county has one. You can check plan availability at [Medicare.gov's plan finder](https://www.medicare.gov/plan-compare).
...
Your best free resource, and I mean genuinely excellent, is your local SHIP (State Health Insurance Assistance Program) office. [SHIP counselors at shiphelp.org](https://www.shiphelp.org/) are federally funded, free, unbiased, and trained specifically on your state's Medicaid rules. This is not the same as calling a Medicare plan's sales line. SHIP counselors don't sell anything. I've referred hundreds of people to SHIP over the years and I've never heard a bad outcome.

[AARP's Medicare resource center](https://www.aarp.org/health/medicare-insurance/) is also worth bookmarking. Their state-by-state Medicaid guides are updated regularly and written for normal people.
...
- [Medicare.gov](https://www.medicare.gov): Official federal Medicare program information, including plan finder and MSP eligibility guidance.
- [KFF (Kaiser Family Foundation) Medicaid Benefits Survey](https://www.kff.org/medicaid/): Annual state-by-state analysis of Medicaid benefit generosity, used to estimate dental benefit values in the chart above.
- [CMS Medicare-Medicaid Coordination Office](https://www.cms.gov/Medicare-Medicaid-Coordination/Medicare-and-Medicaid-Coordination/Medicare-Medicaid-Coordination-Office): Federal office overseeing D-SNP and integrated care model policies.
- [MACPAC (Medicaid and CHIP Payment and Access Commission)](https://www.macpac.gov/): Independent federal advisory commission with detailed dual-eligible enrollment and expenditure data.
- [SHIP National Technical Assistance Center](https://www.shiphelp.org/): Directory of free state-based Medicare counseling programs.
