...
The BALANCE Model would've let Part D plans opt into obesity drug coverage starting January 2027, but CMS delayed it indefinitely in May 2026, according to the [CMS press release from May 6](https://www.cms.gov/newsroom/press-releases/coming-soon-cms-provide-50-monthly-access-glp-1-medications-medicare-beneficiaries). For now, the Bridge is the only Medicare path to obesity-specific GLP-1 coverage. What happens after December 2027? Nobody knows.
