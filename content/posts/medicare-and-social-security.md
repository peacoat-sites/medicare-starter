...
faqs:
  - q: "Do I have to sign up for Medicare if I'm already getting Social Security?"
    a: "If you're already receiving Social Security benefits when you turn 65, you're enrolled in Medicare Parts A and B automatically. No action needed unless you want to decline Part B (which is only advisable in specific situations, like active employer coverage through a large employer)."
  - q: "Can I get Medicare before 65?"
    a: "Yes, in two main situations. If you've received Social Security Disability Insurance (SSDI) for 24 months, you automatically qualify for Medicare regardless of age. People with End-Stage Renal Disease (permanent kidney failure requiring dialysis or a transplant) or ALS (Lou Gehrig's disease) also qualify earlier."
  - q: "What happens to my Medicare premiums if my Social Security benefit is very small?"
    a: "Medicare Part B premiums can't exceed your Social Security benefit. This is called the 'hold harmless' rule. If your Social Security check is $90/month and the Part B premium is $185, Medicare can't take more than $90. However, if you're not receiving Social Security at all, you'll be billed quarterly for the full Part B premium and must pay it directly."
  - q: "Can my spouse's work record count toward my Medicare eligibility?"
...
Let's talk about when to take Social Security, because this decision ripples directly into your Medicare costs.
...
- [Social Security Administration (SSA)](https://www.ssa.gov/): Official source for benefit estimates, IRMAA appeal forms (SSA-44), enrollment rules, and full retirement age schedules.
- [Centers for Medicare & Medicaid Services (CMS)](https://www.cms.gov/): Authoritative data on Medicare premiums, IRMAA thresholds, Part A/B eligibility rules, and enrollment periods.
- [Medicare.gov](https://www.medicare.gov/): The official Medicare site for plan comparisons, drug cost tools, and Open Enrollment guidance.
- [Kaiser Family Foundation Medicare Policy Reports](https://www.kff.org/medicare/): Independent research on Medicare costs, coverage gaps, and beneficiary demographics, widely cited in policy discussions.
- [SSA Publication No. 05-10043, "Medicare"](https://www.ssa.gov/pubs/EN-05-10043.pdf): The SSA's own plain-language guide to how Medicare and Social Security connect, updated regularly.
...
*Photo: [Connor Scott McManus](https://www.pexels.com/@connorscottmcmanus) via Pexels*
