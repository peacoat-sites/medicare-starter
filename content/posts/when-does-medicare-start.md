...
faqs:
  - q: "Does Medicare start automatically when I turn 65?"
    a: "Only in certain cases. If you're already receiving Social Security or Railroad Retirement Board benefits when you turn 65, you'll be automatically enrolled in Medicare Parts A and B, and your card will arrive by mail. If you're not collecting those benefits, you must actively enroll. Don't assume it happens on its own."
  - q: "Can I start Medicare before 65?"
    a: "Yes, in specific circumstances. If you've been receiving Social Security Disability Insurance for 24 consecutive months, Medicare enrollment kicks in automatically in month 25. People diagnosed with ALS are enrolled immediately upon receiving disability benefits. People with End-Stage Renal Disease can qualify at any age but typically must apply."
  - q: "What if I miss my Initial Enrollment Period?"
    a: "If you miss your IEP and don't have a qualifying reason like employer coverage, you'll have to wait for the General Enrollment Period, which runs from January 1 through March 31 each year, with coverage beginning July 1. You'll also likely face late enrollment penalties on Part B. This is a situation worth avoiding. If you're approaching 65 and unsure whether to enroll, it's better to sign up than to wait and hope."
  - q: "Does my spouse's employer coverage protect me from Medicare penalties?"
...
This is where I've seen the most confusion over the years, and honestly, the most expensive mistakes.
...
**Situation 2: You're 65 or older and covered by an employer plan (employer has 20 or more employees)**

1. You can delay Part B without penalty.
2. Sign up for Part A now, since it's free for most people and doesn't hurt you.
3. Set a reminder for when you plan to retire or lose employer coverage.
4. Enroll in Part B within eight months of losing coverage using the Special Enrollment Period.
5. Enroll in Part D within that same eight-month window to avoid the drug penalty.

**Situation 3: You're collecting Social Security before 65**

1. You'll be automatically enrolled in Medicare Parts A and B at 65. You don't need to do anything.
2. Your Medicare card will arrive in the mail about three months before your 65th birthday.
3. If you don't want Part B (and have employer coverage), you can opt out when you receive the card.

**Situation 4: You're not collecting Social Security at 65**

1. You won't be automatically enrolled. You must sign up actively.
2. Visit Social Security's website (ssa.gov) or call 1-800-MEDICARE to enroll.
3. You can also visit your local Social Security office in person.

| Your Situation | Sign Up for Part A Now? | Sign Up for Part B Now? | Risk if You Wait |
|---|---|---|---|
| Turning 65, no employer coverage | Yes | Yes | Late enrollment penalty |
| Employer coverage, 20+ employees | Yes (it's free) | Can delay | None, if SEP used correctly |
| Employer coverage, under 20 employees | Yes | Yes | Coverage gaps, no penalty protection |
| On COBRA or retiree coverage | Yes | Yes | COBRA/retiree plans don't protect from penalty |
| Receiving SSDI for 24 months | Auto-enrolled | Auto-enrolled | N/A |

## What About Medicare Advantage and Medigap Timing?

Original Medicare (Parts A and B) is just the starting point. Many people add coverage on top.

**Medicare Advantage (Part C)** plans are offered by private insurers approved by Medicare. They replace Original Medicare and typically include drug coverage plus extra benefits like dental or vision. You can enroll in a Medicare Advantage plan during your Initial Enrollment Period, during the Annual Enrollment Period (October 15 to December 7 each year), or during specific Special Enrollment Periods.
...
Only in certain cases. If you're already receiving Social Security or Railroad Retirement Board benefits when you turn 65, you'll be automatically enrolled in Medicare Parts A and B, and your card will arrive by mail. If you're not collecting those benefits, you must actively enroll. Don't assume it happens on its own.

### Can I start Medicare before 65?
...
Yes, it can. If you're covered under your spouse's employer group health plan and that employer has 20 or more employees, you generally qualify for the Special Enrollment Period when that coverage ends. You'll have eight months to enroll in Part B without penalty. Keep documentation of your coverage dates because you may need to prove creditable coverage.

### When does Part D (drug coverage) start?

Part D coverage can start as early as the first day of the month you're first eligible for Medicare, as long as you enrolled during your Initial Enrollment Period. If you enroll later using a Special Enrollment Period, coverage typically begins the first day of the month after the plan receives your enrollment. Check the specifics with your chosen plan, because the start date can vary slightly.
